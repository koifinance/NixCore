...
Note
---------------------
Always use absolute paths to configure and compile nix and the dependencies,
...
install necessary parts of boost:
        ...
        sudo apt-get install libboost-system-dev libboost-filesystem-dev libboost-chrono-dev libboost-program-options-dev libboost-test-dev libboost-thread-dev zlib1g-dev
...
Security
--------
To help make your nix installation more secure by making certain attacks impossible to
...
* Non-executable Stack
    ...
    vulnerable buffers are found. By default, nix should be built with a non-executable stack
...
Disable-wallet mode
--------------------
When the intention is to run only a P2P node without a wallet, nix may be compiled in
