...
class DummySignatureCheckerNIX : public BaseSignatureChecker
{
public:
...
const DummySignatureCheckerNIX dummyCheckerNIX;
} // namespace
...
const BaseSignatureChecker& DummySignatureCreatorNIX::Checker() const
{
    return dummyCheckerNIX;
}
