    ...
    mapper(0)
{
    ...
    ui->nixAtStartup->setToolTip(ui->nixAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->nixAtStartup->setText(ui->nixAtStartup->text().arg(tr(PACKAGE_NAME)));
...
{
    /* Main */
    mapper->addMapping(ui->nixAtStartup, OptionsModel::StartAtStartup);
