...
public:
    CMainParams() {
        ...
        chainTxData = ChainTxData{
            ...
            1559584320, // * UNIX timestamp of last known number of transactions
            266675,  // * total number of transactions between genesis and that timestamp
                        //   (the tx=... number in the SetBestChain debug.log lines)
            0.009042639497345172  // * estimated number of transactions per second after that timestamp
        };
    }
};
